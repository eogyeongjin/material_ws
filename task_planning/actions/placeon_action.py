...
class PlaceOn(BaseAction):
    ...
    def check_precondition(self, **kwargs) -> tuple[bool, str]:
        ...
        if not target_object or self.action_args[0].lower() not in target_object["objectType"].lower():
            return False, f"{self.command} failed: Robot is not holding the correct object to place"
    ...
    def execute(self) -> tuple[bool, str]:
        ...
        if destination_object["objectType"].lower() == "StoveBurner".lower():
            ...
            # destination_object["objectType"].lower() in ["CounterTop".lower(), "DiningTable".lower()]:
